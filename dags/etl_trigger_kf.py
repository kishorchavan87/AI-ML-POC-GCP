...
REGION = "us-central1"
REPO = f"{REGION}-docker.pkg.dev/{PROJECT_ID}/ml-docker-repo"

def trigger_kubeflow():
    client = kfp.Client(host="http://kubeflow-pipeline.kubeflow.svc.cluster.local:8888")
    client.create_run_from_pipeline_package("kfp_pipelines/train_pipeline.py", arguments={})
